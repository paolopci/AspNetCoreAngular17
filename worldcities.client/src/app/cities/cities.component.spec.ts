...
describe('CitiesComponent', () => {
  ...
  beforeEach(async () => {
    ...
    cityService.getData.and.returnValue(
      of<ApiResult<City>>(<ApiResult<City>>{
        data: [
          <City>{
            name: "TestCity1",
            id: 1, lat: 1, lon: 1, countryId: 1, countryName: 'TestCountry1'
          },
          <City>{
            name: "TestCity2",
            id: 2, lat: 1, lon: 1, countryId: 1, countryName: 'TestCountry1'
          },
          <City>{
            name: "TestCity3",
            id: 3, lat: 1, lon: 1, countryId: 1, countryName: 'TestCountry1'
          }
        ],
        totalCount: 3,
        pageIndex: 0,
    ...
    await TestBed.configureTestingModule({
      ...
      imports: [
        BrowserAnimationsModule, AngularMaterialModule, RouterTestingModule
      ],
      providers: [
